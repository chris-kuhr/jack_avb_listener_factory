...
class BezierDrawer(QtGui.QFrame):

	"""Draw a Bezier Curve"""
	def __init__(self, parent):
		super(BezierDrawer, self).__init__(parent)
...
# 		self.setWindowTitle('Bezier Curves')
	...
	def doDrawing(self, qp):
		...
		steps = 1000	
		controlPoints = ((50, 170),(150, 370),(250, 35),(400, 320))
		...
		qp.setPen(bluePen)
		for point in self.bezier_curve_range(steps, controlPoints):
			qp.drawLine(oldPoint[0], oldPoint[1], point[0], point[1])
			oldPoint = point
